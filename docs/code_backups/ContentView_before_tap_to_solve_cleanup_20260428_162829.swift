...
final class AppState: ObservableObject {
        ...
        for r in 0..<9 {
            for c in 0..<9 {
                ...
                if given == 0 && value != 0 {
                    ...
                    digit.position = SCNVector3(x, 0.0007, z)
    ...
    private func makeDigitNode(_ value: Int, scale: Float) -> SCNNode {
        let text = SCNText(string: "\(value)", extrusionDepth: 0.00002)
        text.font = UIFont.systemFont(ofSize: 1.0, weight: .black)
        text.flatness = 0.05

        let digitColor = UIColor(red: 0.00, green: 0.18, blue: 0.85, alpha: 0.96)
            ...
            VStack(spacing: 10) {
                ...
                HStack(spacing: 10) {
                    ...
                    Button {
                        ...
                        Text(appState.showDebugOverlay ? "Hide Debug" : "Show Debug")
                            .font(.subheadline)
                            .bold()
                            .padding(.horizontal, 12)
                            .padding(.vertical, 10)
                ...
                Text("Blue solved numbers are AR-world anchored. Debug overlay is off by default.")
                    .font(.caption2)
                    .multilineTextAlignment(.center)
                    .padding(.horizontal, 12)
            }
                        ...
                        ForEach(0..<81, id: \.self) { idx in
                            ...
                            if isGiven == 0 && value != 0 {
                                ...
                                Text("\(value)")
                                    ...
                                    .foregroundColor(Color(red: 0.00, green: 0.18, blue: 0.85))
...
struct ARSudokuTestView: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, ARSCNViewDelegate {
        ...
        @objc func handleTap(_ recognizer: UITapGestureRecognizer) {
            ...
            Task { @MainActor in
                self.appState?.statusText = "Placed test grid. Now send a frame to solver."
            }
        }
