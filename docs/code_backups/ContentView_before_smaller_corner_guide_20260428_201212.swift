    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 5) {
                ...
                Text(appState.isSolving ? "Solving..." : (appState.hasActiveSolutionOverlay ? "Tap again to rescan" : "Fit puzzle inside corners, then tap"))
                    .font(.caption2)
...
struct CornerCaptureGuide: View {
    var body: some View {
        GeometryReader { geo in
            let guideWidth = geo.size.width * 0.76
            ...
            ZStack {
                ...
                Text("Fit puzzle inside corners")
                    .font(.caption2)
