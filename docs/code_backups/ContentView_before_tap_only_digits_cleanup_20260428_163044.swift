...
final class AppState: ObservableObject {
    ...
    private func makeWorldSolutionNode(
        ...
        let textScale = min(width, height) / 24.0
        ...
        for r in 0..<9 {
            for c in 0..<9 {
                ...
                if given == 0 && value != 0 {
                    ...
                    digit.position = SCNVector3(x, 0.00015, z)
    ...
    private func makeDigitNode(_ value: Int, scale: Float) -> SCNNode {
        ...
        let digitColor = UIColor(red: 0.16, green: 0.35, blue: 0.95, alpha: 0.98)
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ARSudokuTestView(appState: appState)
                ...
                .onTapGesture {
                    Task {
                        await appState.solveCurrentFrame()
                    }
                }
                .ignoresSafeArea()
...
struct ARSudokuTestView: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, ARSCNViewDelegate {
        ...
        // Disabled: old tap-to-place-test-overlay behavior removed.
        return
